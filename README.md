...
![Portfolio Site](https://img.shields.io/badge/Portfolio-Live%20Site-b89a74?style=flat-square)
![Python](https://img.shields.io/badge/Python-3.10+-3d2314?style=flat-square&logo=python&logoColor=white)
![License: MIT](https://img.shields.io/badge/License-MIT-c4694f?style=flat-square)
---
Overview
...
Dataset: UCI Online Retail (541K transactions, UK e-commerce)
...
Dataset: Kaggle Marketing Data (2,240 customers, multi-channel CRM)
...
Dataset: UCI Online Retail (same as Case Study 01)
...
Dataset	Destination
UCI Online Retail (.xlsx)	`01-ltv-analysis/data/online_retail.xlsx` and `03-cohort-analysis/data/online_retail.xlsx`
Kaggle Marketing Data (.csv)	`02-cac-analysis/data/marketing_data.csv`
4. Run the notebooks
```bash
jupyter notebook
```
...
Kaggle Marketing Dataset — jackdaoud/marketing-data
---
Contact
